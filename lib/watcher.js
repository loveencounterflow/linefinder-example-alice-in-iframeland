(function() {
  'use strict';
  var $, Async_pipeline, FS, G, GUY, Intersock, My_watcher, PATH, Pipeline, after, alert, create_pipeline, debug, defer, demo, echo, file_dt, help, info, inspect, log, plain, praise, rpr, sleep, urge, warn, whisper, xxx;
