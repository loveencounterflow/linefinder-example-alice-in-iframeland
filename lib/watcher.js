(function() {
  'use strict';
  var $, Async_pipeline, FS, G, GUY, Intersock, My_watcher, PATH, Pipeline, after, alert, create_pipeline, debug, defer, demo, demo_websocket, echo, file_dt, help, info, inspect, log, plain, praise, rpr, sleep, urge, warn, whisper, xxx;
  ...
  demo = function() {
    return new Promise(async(resolve, reject) => {
      var FiveServer, cfg, mode, pipeline, server, watcher;
  ...
  remove(files(like(public/browserified/mudom+linefinder.js.tmp-browserify-09944284741688802498)));
